...
int main()
{
	...
	new MultipleChoice("Who were the very first servants of Makuta Teridax?",
		             { "Bohrok", "Rahkshi", "Barraki", "Bohrok Va" }, 0, 2);

	new MultipleChoice("The Barraki had an certain slogan which is also used as a phrase in a song by Cryoshell.\nWhat is the Barraki\'s own slogan?",
